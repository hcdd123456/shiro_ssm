...
<html>
  ...
  <body>
  	...
  	<!-- 工具条 -->
  	<div id="tb">
		<shiro:hasRole name="班长"><a id="addBtn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加</a></shiro:hasRole>
		<shiro:hasRole name="班长"><a id="editBtn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">修改</a></shiro:hasRole>
		<shiro:hasRole name="班长"><a id="deleteBtn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">删除</a></shiro:hasRole>
	</div>
