  ...
  <body class="easyui-layout"> 
    ...
    <div data-options="region:'north',split:true" style="height:80px;">
    	...
    	<div id="loginDiv" style="position: absolute;right: 20px;top: 20px;">
			<shiro:hasRole name="班长">欢迎你，[超级管理员:<shiro:principal></shiro:principal>]!</shiro:hasRole>
			<shiro:lacksRole name="班长">欢迎你，[普通管理员:<shiro:principal></shiro:principal>]!</shiro:lacksRole>
    	</div>
